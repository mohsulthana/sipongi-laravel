    ...
    <div id="horizon" v-cloak>
        ...
        <div class="container mb-5">
            <div class="d-flex align-items-center py-4 header">
                ...
                <h4 class="mb-0 ml-2"><strong>OpsRoom</strong> - Jobs Monitoring</h4>
            ...
            <div class="row mt-4">
                <div class="col-2 sidebar">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <router-link active-class="active" to="/recent-jobs"
                                class="nav-link d-flex align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                    <path
...
</html><?php /**PATH /var/www/html/sipongiplus/sipongi-dev/resources/views/vendor/horizon/layout.blade.php ENDPATH**/ ?>