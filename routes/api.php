...
Route::group([
    ...
    Route::get('getDataGambut/{provId}', 'KotaKabController@getPetaGambut');
    Route::get('getDataMoratorium/{provId}', 'KotaKabController@getPetaMoratorium');
    ...
    // edited by hendie17@gmail.com
    Route::group(['namespace' => 'Fdrs','prefix' => 'fdrs'], function () {
        Route::get('getData', 'BmkgController@index');
        Route::get('store', 'BmkgStoreController@index');
    });
