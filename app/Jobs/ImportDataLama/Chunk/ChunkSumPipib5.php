...
class ChunkSumPipib5 implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        DB::table('sum_pipib_5')->insertOrIgnore($data);
        DB::delete(
            'DELETE FROM sum_pipib_5 WHERE id IN ( 
                SELECT id FROM ( 
                    SELECT id, row_number() OVER w as rnum FROM sum_pipib_5 
                    WINDOW w AS ( 
    ...
    {
        return ['migrasi', 'migrasi:sum-pipib-5', 'sum-pipib-5:insert-data'];
    }
