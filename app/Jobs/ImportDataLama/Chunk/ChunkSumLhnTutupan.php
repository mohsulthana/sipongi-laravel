...
class ChunkSumLhnTutupan implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        DB::table('sum_lhn_tutupan')->insertOrIgnore($data);
        DB::delete(
            'DELETE FROM sum_lhn_tutupan WHERE id IN ( 
                SELECT id FROM ( 
                    SELECT id, row_number() OVER w as rnum FROM sum_lhn_tutupan 
                    WINDOW w AS ( 
    ...
    {
        return ['migrasi', 'migrasi:sum-lhn-tutupan', 'sum-lhn-tutupan:insert-data'];
    }
