...
class ChunkSumEnergi implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        DB::table('sum_energi')->insertOrIgnore($data);
        DB::delete(
            'DELETE FROM sum_energi WHERE id IN ( 
                SELECT id FROM ( 
                    SELECT id, row_number() OVER w as rnum FROM sum_energi 
                    WINDOW w AS ( 
    ...
    {
        return ['migrasi', 'migrasi:sum-energi', 'sum-energi:insert-data'];
    }
