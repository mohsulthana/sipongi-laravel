...
class ChunkHotspotSatelitDeleted implements ShouldQueue
{
    ...
    {
        return ['migrasi', 'migrasi:hotspot-satelit-removed', 'hotspot-satelit-removed:insert-data'];
    }
