...
class ChunkSumPipib6 implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        DB::table('sum_pipib_6')->insertOrIgnore($data);
        DB::delete(
            'DELETE FROM sum_pipib_6 WHERE id IN ( 
                SELECT id FROM ( 
                    SELECT id, row_number() OVER w as rnum FROM sum_pipib_6 
                    WINDOW w AS ( 
    ...
    {
        return ['migrasi', 'migrasi:sum-pipib-6', 'sum-pipib-6:insert-data'];
    }
